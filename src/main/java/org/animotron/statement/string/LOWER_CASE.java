 ...
 */
public class LOWER_CASE extends DetermInstruction {

	public static final LOWER_CASE _ = new LOWER_CASE();

	private LOWER_CASE() { super("lowercase"); }
	...
	class Calc extends OnQuestion {
        ...
        public void act(final PFlow pf) {
            try {
                ...
                answered(pf, new JExpression(value(source.toLowerCase())));
            } catch (Throwable t) {
                pf.sendException(t);
            }
        }
