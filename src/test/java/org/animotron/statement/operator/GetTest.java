...
public class GetTest extends ATest {
	...
	public void getOnManyAN() throws Exception {
    	...
    	JExpression test = new JExpression(
			_(THE._, "d", _(GETALL._, "Z", _(AN._, "A"), _(AN._, "B")))
		);
    	assertAnimoResultOneStep(test, "the d (Z \"A\") (Z \"B\").");

    	test = new JExpression(
			_(GETALL._, "Z", _(AN._, "A"), _(AN._, "B"))
		);
	...
	public void getFromPFlow_an_with_param() throws Exception {
    	...
    	JExpression.__(new JExpression(
            _(THE._, "A", element("B" , _(GETALL._, "C")))
        ));
    	JExpression test = new JExpression(
	...
	public void getFromPFlow_cross_an_with_param() throws Exception {
        ...
        JExpression.__(
            new JExpression(
                _(THE._, "A", _(AN._, "B", _(GETALL._, "C")))
            ),
            new JExpression(
                _(THE._, "D", element("E", _(GETALL._, "B")))
            )
        );
    ...
    public void getFromPFlow_an_with_stack() throws Exception {
        ...
        JExpression.__(
            new JExpression(
                _(THE._, "A", _(GETALL._, "X"))
            ),
            new JExpression(
                _(THE._, "B", _(GETALL._, "Y"), _(AN._, "A"))
            ),
            new JExpression(
                _(THE._, "C", _(GETALL._, "Z"), _(AN._, "B"))
            )
        );
    ...
    public void getFromPFlow_more_an_with_stack() throws Exception {
        ...
        JExpression.__(
            new JExpression(
                _(THE._, "A", _(GETALL._, "X"), _(AN._, "Z", text("γ")))
            ),
            new JExpression(
                _(THE._, "B", _(GETALL._, "Y"), _(AN._, "A"))
            ),
            new JExpression(
                _(THE._, "C", _(GETALL._, "Z"))
            )
        );
    ...
    public void getFromPFlow_an_an_an() throws Exception {
        ...
        JExpression.__(
            new JExpression(
                _(THE._, "A", _(AN._, "Y", _(GETALL._, "X")))
            ),
            new JExpression(
                _(THE._, "B", _(AN._, "Z", _(GETALL._, "Y")))
            ),
            new JExpression(
                _(THE._, "C", _(GETALL._, "Z"))
            )
