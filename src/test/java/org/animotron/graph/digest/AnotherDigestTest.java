 ...
 */
package org.animotron.graph.digest;
 ...
 *
 */
public class AnotherDigestTest extends ATest {

    private static final XMLInputFactory FACTORY = new WstxInputFactory();

    private void test(String xml) throws Exception {
        Expression x = new StAXExpression(FACTORY.createXMLStreamReader(new StringReader(xml)));
        org.junit.Assert.assertEquals(HASH.get(x), key(DigestSerializer.serialize(x)));
    }
	...
	public void test_05() throws Exception {
        test("<a><b><x/></b><c><x/></c></a>");
	}

    @Test
	public void test_06() throws Exception {
        test("<a><b><x/></b><c><x/><y/></c><x><z/></x></a>");
	}
