 ...
 *
 */
public class DigestTest extends ATest {

    private void test(String animo) throws Exception {
        Expression x = new AnimoExpression(animo);
        Assert.assertEquals(HASH.get(x), key(DigestSerializer.serialize(x)));
    }
    ...
    public void test_62() throws Exception {
        test("the a (((--> (b)(c))(d)(e))(f))");
    }

    @Test
    public void test_63() throws Exception {
        test("the a (((--> (b)(c))(d)(e))(f)(g))");
    }
